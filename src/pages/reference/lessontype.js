...
const LessonType = () => {
  ...
  // useEffect(() => {
  //   axios
  //     .post("http://training.erdenetmc.mn/api/ref/lesson/type")
  //     .then(async (data) => {
    ...
    const renderHeader = (filtersKey) => {
      ...
      return (
        <div className="md:flex items-center justify-between mx-2">
          ...
          <button
            className={
              "text-white  bg-gradient-to-r from-green-400 to-blue-500 font-semibold rounded-lg py-2 my-2 w-11/12 md:w-1/6"
            }
            onClick={() => {
              setShow(true);
              dispatch({
              ...
              <div className=" flex-auto justify-between divide-y divide-gray-50 ">
                ...
                <div className=" flex-auto divide-y divide-gray-50 ">
                  ...
                  <div className=" flex justify-end bg-gray-50 gap-3 ">
                    <button
                      className="bg-[#5472D4]  py-2.5 px-6 rounded-sm my-3  text-white  mr-5   "
                      onClick={() => {
                        setShow(false);
                      }}
                    >
...
export default React.memo(LessonType);
