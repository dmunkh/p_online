...
const Employee = () => {
  ...
  //         return (
  //           <div className="grid grid-flow-col bg-blue-50 w-full ">
  //             <div className=" row-span-2 ml-6 text-sm font-semibold ">
  //               <span className="ml-1">{data.organization_name}</span>
  //             </div>
  //             <div className="flex text-right items-center justify-center gap-2 ">
  //               <button
  //                 title="Ажилтан нэмэх"
  //                 className=" p-1 font-semibold  border-1 border-teal-400 rounded-full bg-teal-500 text-white hover:scale-125 focus:outline-none duration-300 cursor-pointer mr-1"
  //                 onClick={() => {
  //                   dispatch({
  //                     type: "CLEAR_EMPLOYEE",
  //                   });
    ...
    <>
      ...
      >
        ...
        <button type="button" class="btn btn-primary mr-1 w-full">
          <i class="ft-check mr-2"></i>Save
        </button>
        <button type="button" class="btn btn-secondary w-full">
          <i class="ft-x mr-2"></i>Cancel
        </button>
